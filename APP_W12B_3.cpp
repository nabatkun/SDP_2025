/*  Name:  Nate Abatkun						      */
/*  Date:  11/12/2025     						  */
/*  Assignment:  APPW12B-2   						  */
/*  Seat:  F24		Instructor:  Patrick Herak		Time:  12:40 */

/*
Program to practice use of structs by creating a Calendar struct that contains date and time.  
User is asked to input birth date and time and current date and time.  
Calendar date and time are  converted to seconds from a "zero" time, 
then the time difference is computed in seconds and that time difference converted 
back to elapsed time in years, months, etc. and stored in a third Calendar struct.
*/
...
{
    printf("************************************************\n");
    printf("*  Name:  Nate Abatkun    Date:  12/11/25      *\n");
    printf("*  Seat:  F24   File:  APP_W12B_3.cpp          *\n");
    printf("*  Instructor:  Patrick Herak 12:40              *\n");
    printf("************************************************\n\n");
	
/* 
   Declare three instances of "struct Calendar".

   Declare three long integer variables to hold the seconds from zero until 
   birth, the seconds from zero until now, and the difference in seconds between the two.
...
/* 
   Calculate the difference of the two times, in seconds, and use the 
   ConvertToCalendar () function to get this in terms of all "struct Calendar" variables.
*/
...
/* 
   SecondsFromZero () returns the number of seconds a variable of type 
   "struct Calendar" is from the reference time. 
   According to current settings, 
   this reference time is Jan 1, 1980 at 00:00:00. 
   The year (1980) can be modified, 
   but the other elements of the date may not be changed in this code. 
*/
...
*/
  ...
  second_seconds = (t.second - SECOND_ZERO) * 1;
